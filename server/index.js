...
// Database connection
mongoose.connect(process.env.MONGODB_URI || 'mongodb+srv://prabhathdilshan2001:1234@as.gp7z1.mongodb.net/dt_tenders_app', {
...
// Export for serverless environment (Vercel)
module.exports = app;
